# C12  — statement + minutes[substantive] + press_conf[chair] × modal + predicate
...
- E5 ledger: VIX 확정 7 / 시대구성 21 / 2020의존 9; CFNAI 확정 6 / 3 / 1
...
- H4: **부분** — 확정 VIX 단위 7 (비성명서 층 6, 성명서 층 1)
- H5: **기각** — Granger text→macro q<.10: 0건 (최소 q=0.7764396653447412); 예측 회귀 q<.10: 0/50 (최소 q=0.5877795199919974)