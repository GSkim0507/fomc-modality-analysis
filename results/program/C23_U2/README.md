# C23  — minutes[substantive] + press_conf[chair] × modal + predicate
...
- E5 ledger: VIX 확정 6 / 시대구성 16 / 2020의존 9; CFNAI 확정 6 / 1 / 1
...
- H5: **기각** — Granger text→macro q<.10: 0건 (최소 q=0.8490321308393668); 예측 회귀 q<.10: 0/40 (최소 q=0.564868721091734)