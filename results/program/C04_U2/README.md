# C04  — statement + press_conf[chair] × modal + predicate
...
- E5 ledger: VIX 확정 1 / 시대구성 14 / 2020의존 5; CFNAI 확정 0 / 3 / 1
...
- H5: **기각** — Granger text→macro q<.10: 0건 (최소 q=0.6973839903278221); 예측 회귀 q<.10: 0/38 (최소 q=0.6091533207189791)