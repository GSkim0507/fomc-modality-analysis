# C21 S5 — minutes[substantive] × modal + predicate
...
- E5 ledger: VIX 확정 6 / 시대구성 7 / 2020의존 4; CFNAI 확정 6 / 0 / 0
...
- H4: **지지** — 확정 VIX 단위 6 (비성명서 층 6, 성명서 층 0)
- H5: **기각** — Granger text→macro q<.10: 0건 (최소 q=0.8490321308393668); 예측 회귀 q<.10: 0/24 (최소 q=0.11531158139192231)