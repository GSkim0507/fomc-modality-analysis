# C24 S6 — unfiltered 4 genres (v2-like) × modal + verb class
...
- E5 ledger: VIX 확정 14 / 시대구성 36 / 2020의존 10; CFNAI 확정 12 / 8 / 8
...
- H4: **부분** — 확정 VIX 단위 14 (비성명서 층 13, 성명서 층 1)
- H5: **기각** — Granger text→macro q<.10: 0건 (최소 q=0.22773960455044043); 예측 회귀 q<.10: 0/84 (최소 q=0.44749526787372806)