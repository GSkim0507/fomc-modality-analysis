# 시나리오 S3_U2 — statement + minutes (all substantive layers) × modal + predicate
...
- 전수 스크린 1104행(층위 수준 집계): T1 BH q<.05 적중 34; **확정**(T1·T2 유의·동부호 + 2014–19/2021–26 반기 동부호) VIX 7건 / CFNAI 6건; T1에서만 유의(2020 의존) 18건; T1·T2 유의하나 반기 부호 불일치(시대 구성 효과) 14건
...
- excl-2020 CCF 피크(Pearson·Spearman 동시 유의) 19건; Granger text→macro q<.10 0건
