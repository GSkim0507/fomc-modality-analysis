# 시나리오 S1_U3 — statement only × modal + verb class
...
- 전수 스크린 260행(층위 수준 집계): T1 BH q<.05 적중 20; **확정**(T1·T2 유의·동부호 + 2014–19/2021–26 반기 동부호) VIX 1건 / CFNAI 1건; T1에서만 유의(2020 의존) 1건; T1·T2 유의하나 반기 부호 불일치(시대 구성 효과) 7건
...
- excl-2020 CCF 피크(Pearson·Spearman 동시 유의) 13건; Granger text→macro q<.10 0건
