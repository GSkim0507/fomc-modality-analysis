# 시나리오 S3_U3 — statement + minutes (all substantive layers) × modal + verb class
...
- 전수 스크린 1282행(층위 수준 집계): T1 BH q<.05 적중 40; **확정**(T1·T2 유의·동부호 + 2014–19/2021–26 반기 동부호) VIX 10건 / CFNAI 8건; T1에서만 유의(2020 의존) 22건; T1·T2 유의하나 반기 부호 불일치(시대 구성 효과) 15건
