# 시나리오 S6_U3 — unfiltered 4 genres (v2-like) × modal + verb class
...
- 주 층위 Statement: 조동사별 1위 단위 will→will/activity (22%), would→would/copular_adj (94%), could→could/causative (100%), can→can/copular_adj (50%), should→should/activity (64%), may→may/causative (59%); 조동사 간 JSD 1.00–1.00

## X-B 구문 계단 (성명서)

- 회의 101회, 상위 단위 12개에서 PELT 변화점 26개, 그중 정책 사건 ±1회의 이내 17개.
...
- 보유율 반감기(회의 수): all=≥24, will=≥24, would=≥24, could=≥24, can=1.0, should=7.5, may=4.0, modal_sentences=4.5
...
- 전수 스크린 3860행(층위 수준 집계): T1 BH q<.05 적중 81; **확정**(T1·T2 유의·동부호 + 2014–19/2021–26 반기 동부호) VIX 14건 / CFNAI 12건; T1에서만 유의(2020 의존) 62건; T1·T2 유의하나 반기 부호 불일치(시대 구성 효과) 44건
...
| min_statement_quote | will/mental | vix | -0.329 | -0.398 | -0.381 | -0.354 | -0.256 | 104 |
