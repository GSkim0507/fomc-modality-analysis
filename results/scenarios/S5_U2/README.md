# 시나리오 S5_U2 — minutes only (substantive layers) × modal + predicate
...
- 주 층위 Minutes: Desk/markets (staff): 조동사별 1위 단위 will→will+decline (9%), would→would+continue (7%), could→could+affect (5%), can→can+implement (20%), should→should+continue (7%), may→may+contribute (17%); 조동사 간 JSD 1.00–1.00
...
- 전수 스크린 854행(층위 수준 집계): T1 BH q<.05 적중 19; **확정**(T1·T2 유의·동부호 + 2014–19/2021–26 반기 동부호) VIX 6건 / CFNAI 6건; T1에서만 유의(2020 의존) 11건; T1·T2 유의하나 반기 부호 불일치(시대 구성 효과) 7건
...
- excl-2020 CCF 피크(Pearson·Spearman 동시 유의) 16건; Granger text→macro q<.10 0건
